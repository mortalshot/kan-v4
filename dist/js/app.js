(() => {
    ...
    (function webpackUniversalModuleDefinition(root, factory) {
        if ("object" === typeof exports && "object" === typeof module) module.exports = factory(); else if ("function" === typeof define && define.amd) define([], factory); else if ("object" === typeof exports) exports["SwupScriptsPlugin"] = factory(); else root["SwupScriptsPlugin"] = factory();
    })(window, (function() {
        return function(modules) {
            ...
            __nested_webpack_require_559__.d = function(exports, name, getter) {
                if (!__nested_webpack_require_559__.o(exports, name)) Object.defineProperty(exports, name, {
                    enumerable: true,
                    get: getter
                });
            };
            ...
            __nested_webpack_require_559__.t = function(value, mode) {
                if (1 & mode) value = __nested_webpack_require_559__(value);
                ...
                if (2 & mode && "string" != typeof value) for (var key in value) __nested_webpack_require_559__.d(ns, key, function(key) {
                    return value[key];
                }.bind(null, key));
                return ns;
            };
            ...
            return __nested_webpack_require_559__(__nested_webpack_require_559__.s = 0);
        }([ function(module, exports, __nested_webpack_require_4023__) {
            "use strict";
            var _index = __nested_webpack_require_4023__(1);
        ...
        }, function(module, exports, __nested_webpack_require_4401__) {
            "use strict";
            Object.defineProperty(exports, "__esModule", {
                value: true
            });
            ...
            var _plugin = __nested_webpack_require_4401__(2);
            ...
            var ScriptsPlugin = function(_Plugin) {
                ...
                function ScriptsPlugin(options) {
                    ...
                    _this.runScript = function(originalElement) {
                        ...
                        try {
                            for (var _step, _iterator = arrayify(originalElement.attributes)[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    (function e(t, n) {
        ...
        return function(e) {
            ...
            t.getCurrentUrl = p.default;
            t.markSwupElements = g.default;
            t.Link = y.default;
        }, function(e, t, n) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                    ...
                    value: function e(t) {
                        if (!t.metaKey && !t.ctrlKey && !t.shiftKey && !t.altKey) {
                            if (0 === t.button) {
                                ...
                                if (n.getAddress() == (0, j.getCurrentUrl)() || "" == n.getAddress()) if ("" != n.getHash()) {
            ...
            var a = function e(t, n) {
                ...
                var u = function e() {
                    ...
                    if (!n) {
                        var r = void 0;
                        if (null != a.scrollToElement) r = t.url + a.scrollToElement; else r = t.url;
            ...
            var a = function e(t, n) {
                ...
                var o = [];
                var s = function e(t) {
                    if (null == a.querySelector(n[t])) return {
                        v: null
            ...
            var r = function e() {
                ...
                for (var r in n) if (void 0 !== t.style[r]) return n[r];
                return false;
            };
            t.default = r;
        }, function(e, t, n) {
            ...
            var i = function e(t, n) {
                var i = 0;
                var a = function e(a) {
                    if (null == t.querySelector(n[a])) console.warn("Element " + n[a] + " is not in current page."); else (0, 
                    r.queryAll)(n[a]).forEach((function(e, o) {
