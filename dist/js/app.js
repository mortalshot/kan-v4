(() => {
    var __webpack_modules__ = {
        ...
        758: (module, __unused_webpack_exports, __webpack_require__) => {
            ...
            var extend = __webpack_require__(820);
            var raf = __webpack_require__.g.requestAnimationFrame;
            var cancelRaf = __webpack_require__.g.cancelAnimationFrame;
            var FORWARD = 1;
            var BACKWARD = -1;
            var propNames = {
            ...
            Scrolltrigger.loop = function loop(inst) {
                ...
                function _loop() {
                    ...
                    if ("undefined" === typeof scroll) throw new Error("Couldn’t get scroll position from container element");
                    if (inst.immediatePreviousScroll !== scroll) inst.points.forEach((function(point) {
                        point.update(scroll);
                    }));
            ...
            Scrolltrigger.prototype.stopListening = function() {
                ...
                if (isWindow()) window.removeEventListener("resize", self.resizeHandler);
            };
            ...
            Point.prototype.update = function(scroll) {
                ...
                if (crossedForward || crossedBackward) self.callback(direction, self);
                self.previousScroll = scroll;
            };
            ...
            function isWindow() {
                return "undefined" !== typeof window && "addEventListener" in window;
            }
